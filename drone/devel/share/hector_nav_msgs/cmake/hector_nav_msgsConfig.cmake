...
if("TRUE" STREQUAL "TRUE")
  set(hector_nav_msgs_SOURCE_PREFIX /home/josemaria/dev/drone/src/ros-drone-master/hector_quadrotor_tutorial/hector_slam/hector_nav_msgs)
  set(hector_nav_msgs_DEVEL_PREFIX /home/josemaria/dev/drone/devel)
  ...
  set(hector_nav_msgs_INSTALL_PREFIX /home/josemaria/dev/drone/install)
...
if(NOT "/home/josemaria/dev/drone/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hector_nav_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/josemaria/dev/drone/src/ros-drone-master/hector_quadrotor_tutorial/hector_slam/hector_nav_msgs/${idir}'.  Ask the maintainer 'Johannes Meyer <meyer@fsr.tu-darmstadt.de>' to fix it.")
    endif()
...
set(hector_nav_msgs_EXPORTED_TARGETS "hector_nav_msgs_generate_messages_cpp;hector_nav_msgs_generate_messages_lisp;hector_nav_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${hector_nav_msgs_dep}_FOUND)
      find_package(${hector_nav_msgs_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${hector_nav_msgs_dep} REQUIRED ${depend_list})
  endif()
