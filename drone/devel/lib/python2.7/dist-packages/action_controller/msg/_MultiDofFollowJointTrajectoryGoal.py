...
class MultiDofFollowJointTrajectoryGoal(genpy.Message):
  _md5sum = "f517c0919226c86aaea44f94f6c54bf9"
...
"""
  ...
  _slot_types = ['trajectory_msgs/MultiDOFJointTrajectory']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.trajectory is None:
        self.trajectory = trajectory_msgs.msg.MultiDOFJointTrajectory()
    else:
      self.trajectory = trajectory_msgs.msg.MultiDOFJointTrajectory()
