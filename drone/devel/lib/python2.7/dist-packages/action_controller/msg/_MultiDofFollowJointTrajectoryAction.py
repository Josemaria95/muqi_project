...
class MultiDofFollowJointTrajectoryAction(genpy.Message):
  _md5sum = "c9d632efe8ad62964a8057cf20eccfea"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      for val1 in self.action_feedback.feedback.desired.velocities:
        _v10 = val1.linear
        _x = _v10
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
        _v11 = val1.angular
      ...
      buff.write(_struct_I.pack(length))
      for val1 in self.action_feedback.feedback.desired.accelerations:
        _v12 = val1.linear
        _x = _v12
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
        _v13 = val1.angular
      ...
      buff.write(_struct_I.pack(length))
      for val1 in self.action_feedback.feedback.actual.velocities:
        _v16 = val1.linear
        _x = _v16
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
        _v17 = val1.angular
      ...
      buff.write(_struct_I.pack(length))
      for val1 in self.action_feedback.feedback.actual.accelerations:
        _v18 = val1.linear
        _x = _v18
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
        _v19 = val1.angular
      ...
      buff.write(_struct_I.pack(length))
      for val1 in self.action_feedback.feedback.error.velocities:
        _v22 = val1.linear
        _x = _v22
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
        _v23 = val1.angular
      ...
      buff.write(_struct_I.pack(length))
      for val1 in self.action_feedback.feedback.error.accelerations:
        _v24 = val1.linear
        _x = _v24
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
        _v25 = val1.angular
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_feedback.feedback.desired.velocities = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z,) = _struct_3d.unpack(str[start:end])
        self.action_feedback.feedback.desired.velocities.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_feedback.feedback.desired.accelerations = []
      for i in range(0, length):
        val1 = geometry_msgs.msg.Twist()
        _v37 = val1.linear
        _x = _v37
        ...
        (_x.x, _x.y, _x.z,) = _struct_3d.unpack(str[start:end])
        self.action_feedback.feedback.desired.accelerations.append(val1)
      _x = self
      start = end
      end += 8
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_feedback.feedback.actual.velocities = []
      for i in range(0, length):
        val1 = geometry_msgs.msg.Twist()
        _v41 = val1.linear
        _x = _v41
        ...
        (_x.x, _x.y, _x.z,) = _struct_3d.unpack(str[start:end])
        self.action_feedback.feedback.actual.velocities.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_feedback.feedback.actual.accelerations = []
      for i in range(0, length):
        val1 = geometry_msgs.msg.Twist()
        _v43 = val1.linear
        _x = _v43
        ...
        (_x.x, _x.y, _x.z,) = _struct_3d.unpack(str[start:end])
        self.action_feedback.feedback.actual.accelerations.append(val1)
      _x = self
      start = end
      end += 8
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_feedback.feedback.error.velocities = []
      for i in range(0, length):
        val1 = geometry_msgs.msg.Twist()
        _v47 = val1.linear
        _x = _v47
        ...
        (_x.x, _x.y, _x.z,) = _struct_3d.unpack(str[start:end])
        self.action_feedback.feedback.error.velocities.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_feedback.feedback.error.accelerations = []
      for i in range(0, length):
        val1 = geometry_msgs.msg.Twist()
        _v49 = val1.linear
        _x = _v49
        ...
        (_x.x, _x.y, _x.z,) = _struct_3d.unpack(str[start:end])
        self.action_feedback.feedback.error.accelerations.append(val1)
      _x = self
      start = end
      end += 8
