...
"""autogenerated by genpy from action_controller/MultiDofFollowJointTrajectoryActionResult.msg. Do not edit."""
import sys
...
class MultiDofFollowJointTrajectoryActionResult(genpy.Message):
  _md5sum = "bce83d50f7bb28226801436caf0e2043"
  _type = "action_controller/MultiDofFollowJointTrajectoryActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_controller/MultiDofFollowJointTrajectoryResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MultiDofFollowJointTrajectoryActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = action_controller.msg.MultiDofFollowJointTrajectoryResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = action_controller.msg.MultiDofFollowJointTrajectoryResult()
