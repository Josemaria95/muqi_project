...
if("FALSE" STREQUAL "TRUE")
  set(moveit_simple_controller_manager_SOURCE_PREFIX /home/josemaria/dev/drone/src/autonomous-flight-ros/ROS - Indigo/moveit_simple_controller_manager)
  set(moveit_simple_controller_manager_DEVEL_PREFIX /home/josemaria/dev/drone/devel)
  ...
  set(moveit_simple_controller_manager_INSTALL_PREFIX /home/josemaria/dev/drone/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_simple_controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/josemaria/dev/drone/install/${idir}'.  Ask the maintainer 'Michael Ferguson <fergs@unboundedrobotics.com>' to fix it.")
    endif()
...
set(moveit_simple_controller_manager_EXPORTED_TARGETS "moveit_simple_controller_manager_generate_messages_cpp;moveit_simple_controller_manager_generate_messages_lisp;moveit_simple_controller_manager_generate_messages_py")
