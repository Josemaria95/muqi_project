...
if("FALSE" STREQUAL "TRUE")
  set(quadrotore2_moveit_SOURCE_PREFIX /home/josemaria/dev/drone/src/ros-drone-master/quadrotore2_moveit)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'quadrotore2_moveit' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/josemaria/dev/drone/install/${idir}'.  Ask the maintainer 'MoveIt Setup Assistant <assistant@moveit.ros.org>' to fix it.")
    endif()
