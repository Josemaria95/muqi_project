...
if("FALSE" STREQUAL "TRUE")
  set(hector_trajectory_server_SOURCE_PREFIX /home/josemaria/dev/drone/src/ros-drone-master/hector_quadrotor_tutorial/hector_slam/hector_trajectory_server)
  set(hector_trajectory_server_DEVEL_PREFIX /home/josemaria/dev/drone/devel)
  ...
  set(hector_trajectory_server_INSTALL_PREFIX /home/josemaria/dev/drone/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hector_trajectory_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/josemaria/dev/drone/install/${idir}'.  Ask the maintainer 'Johannes Meyer <meyer@fsr.tu-darmstadt.de>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${hector_trajectory_server_dep}_FOUND)
      find_package(${hector_trajectory_server_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${hector_trajectory_server_dep} REQUIRED ${depend_list})
  endif()
